...
class SaleOrder(models.Model):
    ...
    def _company_monthly_invoicing_today(self):
        ...
        first_day_of_last_month = first_day_of_this_month - relativedelta.relativedelta(
            months=1
        )
        last_day_of_this_month = (today + relativedelta.relativedelta(day=31)).day
        # Last month still not executed, it needs to be done
        domain_last_month = [
            ("invoicing_mode_monthly_last_execution", "<", first_day_of_last_month),
        ]
        # Invoicing day is today or in the past and invoicing not yet done
        domain_this_month = [
            ("invoicing_mode_monthly_last_execution", "<", first_day_of_this_month),
